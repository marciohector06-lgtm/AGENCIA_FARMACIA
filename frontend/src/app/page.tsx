      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-lg">
          ...
          <div className="flex flex-col gap-2">
            <Link href="/agentes/analise-estoque" className="text-sm font-medium text-red-600 hover:text-red-500">
              Rodar Análise de Estoque (Gerente → Financeiro)
            </Link>
            <Link href="/atendimento" className="text-sm font-medium text-red-600 hover:text-red-500">
              Abrir o Atendimento (Avatar)
            </Link>
            <Link href="/auditoria" className="text-sm font-medium text-red-600 hover:text-red-500">
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-lg">
          ...
          <ul className="flex flex-col gap-2">
            {kpis?.logsRecentes.map((log) => (
              <li key={log.id} className="border-b border-slate-200 pb-2 text-sm last:border-0">
                <p className="text-slate-600">{log.decisao_tomada}</p>
